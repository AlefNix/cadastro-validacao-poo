class Validator {
    ...
    emailvalidate(input) {
        ...
        let errorMessage = `Ensira um e-mail no padrão "exemplo@gmail.com"`;
    ...
    onlyletters(input) {
        ...
        let errorMessage = 'Apenas letras neste campo';
    ...
    checked(input) {
        ...
        let errorMessage = `Precisa concordar com os termos para continuar`;
